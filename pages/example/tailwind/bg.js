  ...
  return (
    <div>
      <Head>
        ...
        <meta property="og:url" content={`${process.env.API_URL}/example/tailwind/bg`} />
        <meta property="og:image" content={`${process.env.API_URL}/api/tailwind?title=Blog%20Title%20A&bg=dark`} />
        {/* <!-- Twitter --> */}
        ...
        <meta property="twitter:url" content={`${process.env.API_URL}/example/tailwind/bg`} />
        <meta property="twitter:image" content={`${process.env.API_URL}/api/tailwind?title=Blog%20Title%20A&bg=dark`} />
      </Head>
      ...
      <main className="dark:bg-neutral-900 min-h-screen pb-8">
        ...
        <div className="sm:flex sm:flex-wrap min-h-screen max-w-5xl mx-auto">
          ...
          <div className="sm:w-4/6 px-4 mx-auto pt-4">
            ...
            <a href={`${process.env.API_URL}/api/tailwind?title=Blog%20Title%20A&bg=dark`} target="_blank" rel="noreferrer" className={linkClassName}>/api/tailwind?title=Blog%20Title%20A&bg=dark</a>
            <div className="mt-4">
              <a href={`https://twitter.com/intent/tweet?url=${process.env.API_URL}/example/tailwind/bg`} target="_blank" rel="noreferrer noopener"
            ...
            <div className="mt-4 mb-8">
              <div className="relative h-60 w-auto sm:h-72 lg:h-[22rem] lg:w-full rounded border dark:border-none">
                <Image
                  alt={'Images'}
                  src={`${process.env.API_URL}/api/tailwind?title=Blog%20Title%20A&bg=dark`}
                  layout="fill"
