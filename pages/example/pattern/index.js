  ...
  return (
    <div>
      <Head>
        ...
        <meta property="og:url" content={`${process.env.API_URL}/example/pattern`} />
        <meta property="og:image" content={`${process.env.API_URL}/api/pattern?title=Blog%20Title%20A`} />
        {/* <!-- Twitter --> */}
        ...
        <meta property="twitter:url" content={`${process.env.API_URL}/example/pattern`} />
        <meta property="twitter:image" content={`${process.env.API_URL}/api/pattern?title=Blog%20Title%20A`} />
      </Head>
      ...
      <main className="dark:bg-neutral-900 min-h-screen pb-8">
        ...
        <div className="sm:flex sm:flex-wrap min-h-screen max-w-5xl mx-auto">
          ...
          <div className="sm:w-4/6 px-4 mx-auto pt-4">
            ...
            <a href={`${process.env.API_URL}/api/pattern?title=Blog%20Title%20A`} target="_blank" rel="noreferrer" className={linkClassName}>/api/pattern?title=Blog%20Title%20A</a>
            <div className="mt-4">
              <a href={`https://twitter.com/intent/tweet?url=${process.env.API_URL}/example/pattern&text=try+og+image%0A%0A`} target="_blank" rel="noreferrer noopener"
            ...
            <div className="mt-4 mb-8">
              <div className="relative h-60 w-auto sm:h-72 lg:h-[22rem] lg:w-full rounded border dark:border-none">
                <Image
                  alt={'Images'}
                  src={`${process.env.API_URL}/api/pattern?title=Blog%20Title%20A`}
                  layout="fill"
