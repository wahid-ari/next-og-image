  ...
  return (
    <div>
      <Head>
        ...
        <meta property="twitter:image" content={`${process.env.API_URL}/api/dynamic-image?username=vercel`} />
      </Head>
      ...
      <main className="dark:bg-neutral-900 min-h-screen pb-8">
        ...
        <div className="sm:flex sm:flex-wrap min-h-screen max-w-5xl mx-auto">
          ...
          <div className="sm:w-4/6 px-4 mx-auto pt-4">
            ...
            <div className="mt-4">
              <a href={`https://twitter.com/intent/tweet?url=${process.env.API_URL}/example`} target="_blank" rel="noreferrer noopener"
